...
void show_usage(void) {
    ...
    printf("  shtick generate [shell|all]           Generate shell files\n");
    printf("  shtick shells                         List all supported shells\n");
    printf("  shtick init [shell]                   Show setup instructions\n");
    printf("  shtick completions [shell|all]        Generate shell completions\n");
    printf("\n");
    printf("Examples:\n");
    ...
    printf("  shtick generate all                   # Generate for all 16 shells\n");
    printf("  shtick completions bash               # Generate bash completions\n");
    printf("\n");
    printf("Supported shells (16 total):\n");
    printf("  Common: bash, zsh, fish, ksh, tcsh, csh, dash, pwsh\n");
    printf("  Modern: xonsh, elvish, nu, ion\n");
    printf("  Others: ash, mksh, pdksh, yash\n");
    printf("\n");
    printf("Generate for all shells:\n");
    printf("  shtick generate all                   # Generate for all 16 shells\n");
    printf("  shtick completions all                # Generate completions for all shells\n");
    printf("\n");
    ...
    printf("  Pwsh:     . ~/.config/shtick/completion.ps1\n");
    printf("  Elvish:   use shtick-completions\n");
    printf("  Nu:       source ~/.config/nu/completions/shtick-completions.nu\n");
}